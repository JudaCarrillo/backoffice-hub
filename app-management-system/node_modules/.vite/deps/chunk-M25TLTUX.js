import {
  InputText
} from "./chunk-OXMNPNMK.js";
import {
  CheckIcon
} from "./chunk-DXZYTMZY.js";
import {
  TimesIcon
} from "./chunk-Q7UYG34A.js";
import {
  Tooltip
} from "./chunk-LDW7PLWS.js";
import {
  AngleRightIcon,
  ChevronDownIcon,
  OverlayService
} from "./chunk-ROXR355T.js";
import {
  CSSTransition
} from "./chunk-DRLZVGY2.js";
import {
  SpinnerIcon
} from "./chunk-VAJX4DEX.js";
import {
  Ripple
} from "./chunk-6NIPO5EM.js";
import {
  IconBase
} from "./chunk-IOD5GTHB.js";
import {
  ComponentBase,
  Portal,
  useEventListener,
...
var VirtualScroller = React8.memo(React8.forwardRef(function(inProps, ref) {
  ...
  var _React$useState5 = React8.useState(0), _React$useState6 = _slicedToArray2(_React$useState5, 2), pageState = _React$useState6[0], setPageState = _React$useState6[1];
  ...
  var _React$useState9 = React8.useState(props.numToleratedItems), _React$useState10 = _slicedToArray2(_React$useState9, 2), numToleratedItemsState = _React$useState10[0], setNumToleratedItemsState = _React$useState10[1];
  var _React$useState11 = React8.useState(props.loading || false), _React$useState12 = _slicedToArray2(_React$useState11, 2), loadingState = _React$useState12[0], setLoadingState = _React$useState12[1];
  var _React$useState13 = React8.useState([]), _React$useState14 = _slicedToArray2(_React$useState13, 2), loaderArrState = _React$useState14[0], setLoaderArrState = _React$useState14[1];
...
var DropdownItem = React9.memo(function(props) {
  ...
  return React9.createElement("li", itemProps, checkmark && iconRenderer(), React9.createElement("span", itemGroupLabelProps, content), React9.createElement(Ripple, null));
});
...
var Dropdown = React9.memo(React9.forwardRef(function(inProps, ref) {
  ...
  var _React$useState = React9.useState(""), _React$useState2 = _slicedToArray3(_React$useState, 2), filterState = _React$useState2[0], setFilterState = _React$useState2[1];
  var _React$useState3 = React9.useState(false), _React$useState4 = _slicedToArray3(_React$useState3, 2), focusedState = _React$useState4[0], setFocusedState = _React$useState4[1];
  var _React$useState5 = React9.useState(-1), _React$useState6 = _slicedToArray3(_React$useState5, 2), focusedOptionIndex = _React$useState6[0], setFocusedOptionIndex = _React$useState6[1];
  var _React$useState7 = React9.useState(false), _React$useState8 = _slicedToArray3(_React$useState7, 2), overlayVisibleState = _React$useState8[0], setOverlayVisibleState = _React$useState8[1];
...
var Paginator = React10.memo(React10.forwardRef(function(inProps, ref) {
  ...
  var createElement11 = function createElement12(key, template) {
    var element;
    switch (key) {
      case "FirstPageLink":
    ...
    if (template) {
      if (_typeof4(template) === "object") {
        return template.layout ? template.layout.split(" ").map(function(value) {
          var key = value.trim();
          return createElement11(key, template[key]);
        }) : Object.entries(template).map(function(_ref) {
          var _ref2 = _slicedToArray4(_ref, 2), key = _ref2[0], _template = _ref2[1];
          return createElement11(key, _template);
        });
      }
      return template.split(" ").map(function(value) {
        return createElement11(value.trim());
      });
    }
    return null;
  };
...
//# sourceMappingURL=chunk-M25TLTUX.js.map
