...
import {
  ...
  ChevronDownIcon,
  OverlayService
} from "./chunk-IEI72KRG.js";
import {
  SpinnerIcon
} from "./chunk-RWBOEE7I.js";
import {
  CSSTransition
} from "./chunk-V2FCPUPE.js";
import {
  Ripple
} from "./chunk-S3E2HPUQ.js";
import "./chunk-W7XGYQEH.js";
import {
  Portal
} from "./chunk-2ACV5UCS.js";
import {
  ComponentBase,
  DomHandler,
...
var CascadeSelectSub = React.memo(function(props) {
  var mergeProps = useMergeProps();
  var _React$useState = React.useState(null), _React$useState2 = _slicedToArray(_React$useState, 2), activeOptionState = _React$useState2[0], setActiveOptionState = _React$useState2[1];
  ...
  var findNextItem = function findNextItem2(item2) {
    ...
    return nextItem ? DomHandler.hasClass(nextItem, "p-disabled") || !DomHandler.hasClass(nextItem, "p-cascadeselect-item") ? findNextItem2(nextItem) : nextItem : null;
  };
  var findPrevItem = function findPrevItem2(item2) {
    var prevItem = item2.previousElementSibling;
    return prevItem ? DomHandler.hasClass(prevItem, "p-disabled") || !DomHandler.hasClass(prevItem, "p-cascadeselect-item") ? findPrevItem2(prevItem) : prevItem : null;
  };
  ...
  var createSubmenu = function createSubmenu2(option) {
    if (isOptionGroup(option) && activeOptionState === option) {
      ...
      return React.createElement(CascadeSelectSub, {
        hostName: props.hostName,
        options,
  ...
  var createOption = function createOption2(option, index) {
    ...
    var content = props.template ? ObjectUtils.getJSXElement(props.template, getOptionValue(option)) : React.createElement("span", textProps, getOptionLabelToRender(option));
    var optionGroupIconProps = mergeProps({
      className: cx("optionGroupIcon")
    }, getPTOptions("optionGroupIcon"));
    var icon = props.optionGroupIcon || React.createElement(AngleRightIcon, optionGroupIconProps);
    ...
    return React.createElement("li", _extends({
      key
    }, itemProps), React.createElement("div", contentProps, content, optionGroup, React.createElement(Ripple, null)), submenu);
  };
  ...
  var createList = function createList2() {
    ...
    return React.createElement("ul", listProps, submenu);
  };
  var createElement2 = function createElement3() {
    ...
    return props.level === 0 ? list : React.createElement("div", listWrapperProps, list);
  };
...
var CascadeSelect = React.memo(React.forwardRef(function(inProps, ref) {
  var mergeProps = useMergeProps();
  var context = React.useContext(PrimeReactContext);
  ...
  var _React$useState5 = React.useState(null), _React$useState6 = _slicedToArray(_React$useState5, 2), attributeSelectorState = _React$useState6[0], setAttributeSelectorState = _React$useState6[1];
  ...
  var findModelOptionInGroup = function findModelOptionInGroup2(option, level) {
    if (isOptionGroup(option, level)) {
      ...
      try {
        for (_iterator2.s(); !(_step2 = _iterator2.n()).done; ) {
          ...
          selectedOption = findModelOptionInGroup2(childOption, level + 1);
          if (selectedOption) {
  ...
  var createLabel = function createLabel2() {
    ...
    return React.createElement("span", labelProps, label2);
  };
  ...
  var createDropdownIcon = function createDropdownIcon2() {
    ...
    return React.createElement("div", dropdownButtonProps, dropdownIcon);
  };
  ...
  var createOverlay = function createOverlay2() {
    ...
    var overlay = React.createElement(CSSTransition, _extends({
      nodeRef: overlayRef
    }, transitionProps), React.createElement("div", panelProps, React.createElement("div", wrapperProps, React.createElement(CascadeSelectSub, {
  ...
  var createElement2 = function createElement3() {
    ...
    return React.createElement("div", rootProps, keyboardHelper, labelElement, dropdownIcon, overlay);
  };
